...
function girarRuleta() {
    ...
    var aleatorio = Math.random() < 0.5 ? "sonidoGirar" : "sonidoSorpresa";
    // Obtener el elemento de audio correspondiente
    var audio = document.getElementById(aleatorio);
    // Reproducir el audio
    audio.play();
...
function detenerRuleta() {
    ...
    var audioGirar2 = document.getElementById("sonidoSorpresa");
    audioGirar.pause();
    audioGirar2.pause();
    audioGirar.currentTime = 0;
    audioGirar2.currentTime = 0;
